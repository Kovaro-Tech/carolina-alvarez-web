...
import './App.css'
import './site.css'
const pageMeta = {'/': ['Carolina Álvarez | Abogada', 'Asesoría y defensa jurídica con estrategia, criterio y compromiso.'], '/sobre-mi': ['Sobre Carolina Álvarez | Abogada', 'Trayectoria y formación profesional de Carolina Álvarez.'], '/servicios': ['Servicios Jurídicos | Carolina Álvarez', 'Áreas de práctica: Derecho Penal, Penal Económico y Tributario.'], '/contacto': ['Contacto | Carolina Álvarez', 'Coordine una consulta jurídica con Carolina Álvarez.']}
